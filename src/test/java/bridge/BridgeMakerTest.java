...
class BridgeMakerTest {
    ...
    class Describe_makeBridge {
        ...
        TestNumberGenerator testNumberGenerator = new TestNumberGenerator(newArrayList(1,1,0,0,1,0,1,0));
        BridgeMaker bridgeMaker = new BridgeMaker(testNumberGenerator);

        @DisplayName("생성할 다리의 길이를 입력 받아 임의의 다리 배열을 리턴한다.")
        @Test
        void createShapeTest() {
            assertThat(bridgeMaker.makeBridge(8)).isEqualTo(List.of("U","U","D","D","U","D","U","D"));
        }
    }
}